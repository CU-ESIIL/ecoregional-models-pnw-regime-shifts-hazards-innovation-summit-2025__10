...
- Add your names to **[Team](https://cu-esiil.github.io/ecoregional-models-pnw-regime-shifts-hazards-innovation-summit-2025__10/#team)** (top nav → Team). Edit the table, keep it simple.
...
git clone https://github.com/CU-ESIIL/ecoregional-models-pnw-regime-shifts-hazards-innovation-summit-2025__10.git
cd ecoregional-models-pnw-regime-shifts-hazards-innovation-summit-2025__10
```
